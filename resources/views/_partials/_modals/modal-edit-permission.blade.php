    ...
    <div class="modal-content p-3 p-md-5">
      ...
      <div class="modal-body">
        ...
        <div class="alert alert-warning" role="alert">
          ...
          <p class="mb-0">By editing the permission name, you might break the system permissions functionality. Please
            ensure you're absolutely certain before proceeding.</p>
        </div>

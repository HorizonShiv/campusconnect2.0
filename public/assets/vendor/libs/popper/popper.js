        ...
        !function (e, t) {
          ...
          function p(e, o, i) {
            ...
            var u = (n(e) ? t(e) : window).visualViewport, l = !c() && i,
              d = (a.left + (l && u ? u.offsetLeft : 0)) / f, h = (a.top + (l && u ? u.offsetTop : 0)) / p,
          ...
          function Z(e) {
            void 0 === e && (e = {});
            var t = e, r = t.defaultModifiers, o = void 0 === r ? [] : r, i = t.defaultOptions,
              a = void 0 === i ? K : i;
          ...
          function re(e) {
            var n, r = e.popper, o = e.popperRect, i = e.placement, a = e.variation, f = e.offsets, c = e.position,
              p = e.gpuAcceleration, u = e.adaptive, l = e.roundOffsets, h = e.isFixed, v = f.x,
              y = void 0 === v ? 0 : v, g = f.y, b = void 0 === g ? 0 : g,
          ...
          var ge = {
              name: "hide", enabled: !0, phase: "main", requiresIfExists: ["preventOverflow"], fn: function (e) {
                var t = e.state, n = e.name, r = t.rects.reference, o = t.rects.popper,
                  i = t.modifiersData.preventOverflow, a = J(t, {elementContext: "reference"}),
                  s = J(t, {altBoundary: !0}), f = ve(a, r), c = ve(s, o, i), p = ye(f), u = ye(c);
                t.modifiersData[n] = {
...
// This entry need to be wrapped in an IIFE because it need to be in strict mode.
  ...
  \*******************************************************/
      ...
      /* harmony import */
      var _popperjs_core_dist_umd_popper_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @popperjs/core/dist/umd/popper.min */ "./node_modules/@popperjs/core/dist/umd/popper.min.js");
      /* harmony import */
      var _popperjs_core_dist_umd_popper_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_popperjs_core_dist_umd_popper_min__WEBPACK_IMPORTED_MODULE_0__);
